...
@section('bread')
    ...
    <li class="active" style="color: white;font-size: larger"> Edit Notification </li>
@endsection
...
<div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form role="form" action="{{route('notification.update',['id'=>$notification->id])}}" method="post">
                    @csrf
                    <div class="box-body">
                        <div class="form-group">
                            <label for="store">Enter Title</label>
                            <input type="text" name="title" class="form-control" id="store"
                                   placeholder="title of notification" value="{{$notification->title}}">
                        </div>
                        <div class="form-group">
                            <label for="store">Enter Description</label>
                            <textarea name="desc" id="" cols="30" rows="10"
                                      class="form-control">{{$notification->desc}}</textarea>
