...
<!-- DataTables -->
<script src="{{'/design/adminlte'}}/bower_components/datatables.net/js/jquery.dataTables.min.js"></script>
<script src="{{'/design/adminlte'}}/bower_components/datatables.net-bs/js/dataTables.bootstrap.min.js"></script>
<!-- SlimScroll -->
<script src="{{'/design/adminlte'}}/bower_components/jquery-slimscroll/jquery.slimscroll.min.js"></script>
<!-- FastClick -->
<script src="{{'/design/adminlte'}}/bower_components/fastclick/lib/fastclick.js"></script>
<!-- AdminLTE App -->
<script src="{{'/design/adminlte'}}/dist/js/adminlte.min.js"></script>
<!-- AdminLTE for demo purposes -->
