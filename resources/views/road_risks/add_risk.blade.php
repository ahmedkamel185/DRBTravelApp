...
@section('bread')
    ...
    <li class="active" style="color: white;font-size: larger">add risk</li>
@endsection
@section('content')
        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">Add New Risk</h3>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                <form role="form" action="{{route('road.risks.store')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="box-body">
                        <div class="form-group">
                            <label for="risk">Enter Risk Name Arabic</label>
                            <input type="text" name="name_ar" class="form-control" id="risk"
                                   placeholder="الاسم باللغه العربيه" value="{{old('name_ar')}}">
                        </div>
                        <div class="form-group">
                            <label for="risk_en">Enter Risk Name English</label>
                            <input type="text" name="name_en" class="form-control" id="risk_en"
                                   placeholder="Store Type English" value="{{old('name_en')}}">
                        </div>
                        <div class="form-group">
